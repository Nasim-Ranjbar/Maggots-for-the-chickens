...
make_variables(estimate_read_csv(paste("DA_project.csv")))
...
DA_simulation_results <- mcSimulation(
  estimate = estimate_read_csv("DA_project.csv"),
...
mcSimulation_table <- data.frame(DA_simulation_results$x, 
                                 DA_simulation_results$y[1:3])

evpi_baseline <- multi_EVPI(mc = mcSimulation_table, first_out_var = "NPV_baseline")
evpi_bsfl <- multi_EVPI(mc = mcSimulation_table, first_out_var = "NPV_bsfl")
evpi_decision <- multi_EVPI(mc = mcSimulation_table, first_out_var = "NPV_decision")


# Plot evpi
plot_evpi(evpi_baseline, decision_vars = "NPV_baseline")
plot_evpi(evpi_bsfl, decision_vars = "NPV_bsfl")
